...
| Remote CI | verified | [Run 34286507791](https://github.com/kkmookhey/elcapitan/actions/runs/34286507791) passed after the measured Azure/AWS checkpoint series reached public `main`; the exact release workflow repeats the full gates for the tag |
